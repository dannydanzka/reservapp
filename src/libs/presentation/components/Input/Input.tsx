      ...
      <InputContainer>
        ...
        >
          ...
          <StyledTextInput
            ...
            $hasRightIcon={
              Boolean(rightIcon) || showPasswordToggle || Boolean(error) || Boolean(success)
            }
            $size={size}
          ...
          {(rightIcon || showPasswordToggle || error || success || loading) && (
            <IconContainer position='right'>
              ...
              {!loading && error && <AlertCircle color={theme.colors.error[500]} size={20} />}
              {!loading && success && <Check color={theme.colors.success[500]} size={20} />}
        ...
        {(error || success || helperText) && (
          <HelperTextContainer>
            ...
            {!error && !success && helperText && (
              <HelperText $type='helper'>{helperText}</HelperText>
            )}
          </HelperTextContainer>
        )}
      </InputContainer>
